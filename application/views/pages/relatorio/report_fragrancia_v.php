...
{	
	$montar_tabela .= '	<tr>
							<td style="font-size: 11px; text-align: center; width: 50%">'.$pedido['descricao_mp'].'</td>
...
$html = '<table style="font-size: 13px;" width="100%">
				...
				<tr>
                    <td align="center" colspan="4"><strong>Relação de Fragrâncias Mais Usadas</strong></td>
                </tr>
            </table>
            <br><br><br>
			<table id="basic-datatables" border="0.5">
				<thead>
					<tr>
						<th style="font-size: 12px; font-weight: bolder; text-align: center; width: 50%">Fragrância</th>
